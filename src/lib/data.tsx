    ...
    return [
        ...
        // Mofidra
        {
            ...
            images: [
                ...
                {
                    id: 1,
                    src: "/globydep/weeks.jpg",
                },
                {
                    id: 2,
                    src: "/globydep/loans.jpg",
                },
                {
                    id: 3,
                    src: "/globydep/profil.jpg",
                }
            ],
        ...
        {
            id: 5,
            title: t.projectsData.biblio.title,
            description: t.projectsData.biblio.description,
            detailedDescription: t.projectsData.biblio.detailedDescription,
            technologies: [
                {
                    id: 0,
                    icon: <SiNextdotjs size="1.5rem" title="Next.js" />,
                ...
                {
                    id: 4,
                    icon: <FaJava size="1.5rem" title="Java" />,
                    name: "Java"
                },
            ],
